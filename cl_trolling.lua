...
RegisterNetEvent('j0-admin/client/fling-player', function()
    FlingPlayer()
end)

RegisterNetEvent("j0-admin/client/drunk", function()
    drunkThread()
end)

RegisterNetEvent("j0-admin/client/animal-attack", function()
    startWildAttack()
end)

RegisterNetEvent("j0-admin/client/set-fire", function()
